...
BOARDWIDTH = 8  # number of columns in the board -- Baranje 1
BOARDHEIGHT = 6 # number of rows in the board    -- Baranje 1
TILESIZE = 80
WINDOWWIDTH = 940
WINDOWHEIGHT = 780
FPS = 30
...
def main():
    global FPSCLOCK, DISPLAYSURF, BASICFONT, RESET_SURF, RESET_RECT, NEW_SURF, NEW_RECT, SOLVE_SURF, SOLVE_RECT, HELP_SURF,HELP_RECT, COUNTER
...
def drawBoard(board, message):
    ...
    DISPLAYSURF.blit(HELP_SURF,  HELP_RECT) #--Baranje 2
