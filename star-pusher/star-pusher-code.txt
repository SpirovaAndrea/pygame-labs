...
def main():
    ...
    currentImage = 4 #3rd req: starting character is pinkgirl
    ...
    while True: # main game loop
        ...
        for event in pygame.event.get(): # event handling loop
            if event.type == QUIT:
                ...
                # Handle key presses
                #1st req: switch camera and player button press movements
                keyPressed = True
                if event.key == K_LEFT:
                    cameraLeft = True
